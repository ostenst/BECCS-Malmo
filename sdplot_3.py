...
sample_size = int(len(data) * 0.0075)
...
legend_elements = [
    Line2D([0], [0], marker='o', color='w', label='ti',
           markerfacecolor='gray', markersize=8, alpha=1.0),
    Line2D([0], [0], marker='o', color='w', label='im',
       markerfacecolor='gray', markeredgecolor='black', markersize=8, markeredgewidth=0.6),
    # Line2D([0], [0], marker='o', color='w', label='ti',
...
ax2.plot(
    ...
    markeredgecolor="dimgray",   # Outline color
    markeredgewidth=1.5,
    color="dimgray",
