...
intervals = [(0.0, 1.6), (1.6, 1.9), (1.9, 2.1), (2.1, 2.4), (2.4, 3.0)]  
labels = ["0.0-1.6", "1.6-1.9", "1.9-2.1", "2.1-2.4", "2.4-3.0"] 
...
tick_labels = ["0.0", "1.6", "1.9", "2.1", "2.4", "3.0"]  # Start and end values of intervals
