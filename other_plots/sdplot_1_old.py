...
def assign_color(row):
    ...
    #     return "orange"
    # elif row["crc"] > 190 and row["Auction"] == True:
    #     return "green"
    else:
        return "gray"
...
overlay = data_lhs[(data_lhs["crc"] < 190) & (data_lhs["Auction"] == False)]
ax.scatter(
    overlay["crc"],
    overlay["regret_1"],
    facecolors='none',
    ...
    s=40,
    alpha=0.30,
    label="crc < 190 & Auction = False"
)
# overlay2 = data_lhs[(data_lhs["crc"] > 190) & (data_lhs["Auction"] == True)]
# ax.scatter(
#     overlay2["crc"],
#     overlay2["regret_1"],
#     facecolors='none',
...
legend_elements = [
    Line2D([0], [0], marker='o', color='w', label='Auction = False',
           markerfacecolor='crimson', markersize=8, alpha=1.0),
    Line2D([0], [0], marker='o', color='w', label='Auction = False & crc < 190',
       markerfacecolor='crimson', markeredgecolor='black', markersize=8, markeredgewidth=0.6),
    Line2D([0], [0], marker='o', color='w', label='Auction = True',
